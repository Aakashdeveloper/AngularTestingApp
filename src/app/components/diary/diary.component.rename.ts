...
//   let component: DiaryComponent;
//   let fixture: ComponentFixture<DiaryComponent>;
//   let diaryService: jasmine.SpyObj<DiaryService>
//   let el:DebugElement;

//   beforeEach(async ()=>{
//     const commSpy = jasmine.createSpyObj("diaryService",["getDiaryEntries","addNewDiaryEntry","fetchDiaryEntriesFromServer"])
//     await TestBed.configureTestingModule({
//         imports:[DiaryComponent],
//         providers:[
//             {provide:DiaryService,useValue:commSpy}
//         ]
//     }).compileComponents()

//     diaryService = TestBed.inject(DiaryService) as jasmine.SpyObj<DiaryService>
//     fixture = TestBed.createComponent(DiaryComponent)
...
//   it("should have button and textarea present",()=>{
//     expect(el.query(By.css("button")).nativeElement.innerText).toBe("Save Entry")
//     expect(fixture.nativeElement.querySelector("textarea")).withContext("Can't find input").toBeTruthy()
//     expect(fixture.nativeElement.querySelector("button")).withContext("Can't find button").toBeTruthy()
//   })
